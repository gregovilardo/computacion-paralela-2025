...
void update(const float temp, int grid[1000][1000])
{
    ...
    for (unsigned int i = 0; i < 1000; ++i) {
        for (unsigned int j = 0; j < 1000; ++j) {
            ...
            int spin_neigh_n = grid[(i + 1000 - 1) % 1000][j];
            int spin_neigh_e = grid[i][(j + 1) % 1000];
            int spin_neigh_w = grid[i][(j + 1000 - 1) % 1000];
            int spin_neigh_s = grid[(i + 1) % 1000][j];
...
double calculate(int grid[1000][1000], int* M_max)
{
    ...
    for (unsigned int i = 0; i < 1000; ++i) {
        for (unsigned int j = 0; j < 1000; ++j) {
            int spin = grid[i][j];
            int spin_neigh_n = grid[(i + 1) % 1000][j];
            int spin_neigh_e = grid[i][(j + 1) % 1000];
            int spin_neigh_w = grid[i][(j + 1000 - 1) % 1000];
            int spin_neigh_s = grid[(i + 1000 - 1) % 1000][j];
