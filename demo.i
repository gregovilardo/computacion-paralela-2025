...
typedef float colormap__data[256][3];

static const colormap__data colormap__magma = {
...
static const colormap__data colormap__inferno = {
    {0.001462, 0.000466, 0.013866},
...
static const colormap__data colormap__plasma = {
...
static const colormap__data colormap__viridis = {
...
static const colormap__data colormap__cividis = {
...
static float colormap__clamp(float min, float max, float v) {
...
static void colormap_rgbf(colormap cm, float value, float min, float max, float *r, float *g, float *b) {
    ...
    float step = (max - min) / (float) (((256) - 1));

    float slot;
    float pos = modff((clamped - min) / step, &slot);

    int point1 = (int) slot;
    int point2 = point1 < ((256) - 1) ? point1 + 1: ((256) - 1);

    *r = colormap__lerp((*colormap__ptrs[cm])[point1][0], (*colormap__ptrs[cm])[point2][0], pos);
    *g = colormap__lerp((*colormap__ptrs[cm])[point1][1], (*colormap__ptrs[cm])[point2][1], pos);
...
# 37 "gl2d.h" 3 4
                   0x0DE1
# 37 "gl2d.h"
                                , 0, offset_x, offset_y, width, height, 
# 37 "gl2d.h" 3 4
                                                                        0x1907
# 37 "gl2d.h"
                                                                              , 
...
# 115 "gl2d.h"
    ...
    gl2d->window = glfwCreateWindow(width, height, title, 
# 119 "gl2d.h" 3 4
                                                         ((void *)0)
# 119 "gl2d.h"
                                                             , 
...
void update(const float temp, int grid[1000][1000]);
double calculate(int grid[1000][1000], int* M_max);
# 15 "demo.c" 2
...
# 33 "demo.c"
static void draw(gl2d_t gl2d, float t_now, float t_min, float t_max, int grid[1000][1000])
{
    ...
    for (int i = 0; i < 1000; ++i) {
        ...
        gl2d_draw_rgbf(gl2d, 0, i, 1000, 1, row);
    }
    gl2d_display(gl2d);
}


static void cycle(gl2d_t gl2d, const double initial, const double final, const double step, int grid[1000][1000])
{
    
# 63 "demo.c" 3 4
   ((
# 63 "demo.c"
   (0 < step && initial <= final) || (step < 0 && final <= initial)
# 63 "demo.c" 3 4
   ) ? (void) (0) : __assert_fail (
# 63 "demo.c"
   "(0 < step && initial <= final) || (step < 0 && final <= initial)"
# 63 "demo.c" 3 4
   , "demo.c", 63, __extension__ __PRETTY_FUNCTION__))
# 63 "demo.c"
                                                                           ;
...
static void init(int grid[1000][1000])
{
...
# 89 "demo.c" 3 4
   _Static_assert
# 89 "demo.c"
                (0.01 != 0, "Invalid temperature step");
    
# 90 "demo.c" 3 4
   _Static_assert
# 90 "demo.c"
                (((0.01 > 0) && (1.5 <= 3.0)) || ((0.01 < 0) && (1.5 >= 3.0)), "Invalid temperature range+step");
    
# 91 "demo.c" 3 4
   _Static_assert
# 91 "demo.c"
                (5 + 25 > 0, "Invalid times");
...
# 103 "demo.c"
    ...
    gl2d_t gl2d = gl2d_init("tiny_ising", 1000, 1000);
