...
static void cycle(int grid[1000][1000],
...
# 47 "tiny_ising.c" 3 4
   ((
# 47 "tiny_ising.c"
   (0 < step && min <= max) || (step < 0 && max <= min)
# 47 "tiny_ising.c" 3 4
   ) ? (void) (0) : __assert_fail (
# 47 "tiny_ising.c"
   "(0 < step && min <= max) || (step < 0 && max <= min)"
# 47 "tiny_ising.c" 3 4
   , "tiny_ising.c", 47, __extension__ __PRETTY_FUNCTION__))
# 47 "tiny_ising.c"
                                                               ;
...
# 77 "tiny_ising.c" 3 4
       ((
# 77 "tiny_ising.c"
       index < (1 + (int)((3.0 - 1.5) / 0.01))
# 77 "tiny_ising.c" 3 4
       ) ? (void) (0) : __assert_fail (
# 77 "tiny_ising.c"
       "index < NPOINTS"
# 77 "tiny_ising.c" 3 4
       , "tiny_ising.c", 77, __extension__ __PRETTY_FUNCTION__))
# 77 "tiny_ising.c"
                              ;
        stats[index].t = temp;
...
# 103 "tiny_ising.c" 3 4
   _Static_assert
# 103 "tiny_ising.c"
                (0.01 != 0, "Invalid temperature step");
    
# 104 "tiny_ising.c" 3 4
   _Static_assert
# 104 "tiny_ising.c"
                (((0.01 > 0) && (1.5 <= 3.0)) || ((0.01 < 0) && (1.5 >= 3.0)), "Invalid temperature range+step");
    
# 105 "tiny_ising.c" 3 4
   _Static_assert
# 105 "tiny_ising.c"
                (25 % 5 == 0, "Measurements must be equidistant");
    
# 106 "tiny_ising.c" 3 4
   _Static_assert
# 106 "tiny_ising.c"
                ((1000 * 1000 / 2) * 4ULL < 
# 106 "tiny_ising.c" 3 4
...
# 106 "tiny_ising.c"
    ...
    struct statpoint stat[(1 + (int)((3.0 - 1.5) / 0.01))];
    for (unsigned int i = 0; i < (1 + (int)((3.0 - 1.5) / 0.01)); ++i) {
        stat[i].t = 0.0;
...
# 127 "tiny_ising.c"
    ...
    cycle(grid, 1.5, 3.0, 0.01, 5, stat);
    ...
    for (unsigned int i = 0; i < (1 + (int)((3.0 - 1.5) / 0.01)); ++i) {
        printf("%lf\t%.10lf\t%.10lf\t%.10lf\t%.10lf\t%.10lf\t%.10lf\n",
               stat[i].t,
               stat[i].e / ((double)(1000 * 1000)),
               stat[i].e2 / ((double)(1000 * 1000) * (1000 * 1000)),
               stat[i].e4 / ((double)(1000 * 1000) * (1000 * 1000) * (1000 * 1000) * (1000 * 1000)),
               stat[i].m,
               stat[i].m2,
               stat[i].m4);
    }
